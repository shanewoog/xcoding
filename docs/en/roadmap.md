...
- richer git workflows (Wave S: structured `git_log` + `git_show`; Wave T: approved `git_add` + `git_commit`; Wave U: approved `git_push` without force; pull/reset/force later)
